...
// Create a showtime
router.post('/showtimes', auth.is_auth, auth.is_admin_or_superadmin, async (req, res) => {
...
router.patch('/showtimes/:id', auth.is_auth, auth.is_admin_or_superadmin, async (req, res) => {
  const _id = req.params.id;
...
router.delete('/showtimes/:id', auth.is_auth, auth.is_admin_or_superadmin, async (req, res) => {
  const _id = req.params.id;
  try {
